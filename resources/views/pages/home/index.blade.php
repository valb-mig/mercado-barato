...
@section('content')
    ...
    <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col md:flex-row gap-2">
            <x-section.box title="Mais vendidos" id="mais-vendidos" class="w-full md:w-1/2" icon="dot">
            </x-section.box>

            <x-section.box title="Inventário total" id="inventario-total" class="w-full md:w-1/2" icon="dot">
            </x-section.box>
        </div>

        <div class="row d-flex flex-column gap-2">
            <x-section.box title="Setores" id="capacidade-estoque" class="w-full" icon="dot">
